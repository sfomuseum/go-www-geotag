...
func staticJavascriptGeotagInitJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "static/javascript/geotag.init.js", size: 2766, mode: os.FileMode(420), modTime: time.Unix(1586212631, 0)}
